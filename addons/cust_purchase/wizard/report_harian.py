...
class DailyPurchaseReportXlsx(models.TransientModel):
    _name = 'daily.purchase.report.xlsx'
    _description = 'Daily Purchase Report in Excel'

    report_date = fields.Date(string="Report Date", default=fields.Date.context_today)

    def generate_xlsx_report(self):
        """Method to generate the Excel report for daily purchases."""
        ...
        sheet = workbook.add_worksheet("Daily Purchase Report")
        ...
        attachment = self.env['ir.attachment'].create({
            'name': 'Daily_Purchase_Report.xlsx',
            'type': 'binary',
            'datas': base64.b64encode(output.read()),
            'store_fname': 'daily_purchase_report.xlsx',
